...
public class Player : MonoBehaviour
{
   ...
   [SerializeField] private Color ColorAmarillo;
   [SerializeField] private Color ColorMorado;
   [SerializeField] private Color ColorAzul;
   [SerializeField] private Color ColorRosa;
   private string currentColor;
     ...
     */
     ...
     void ChangeColor()
     {
          ...
          if(randomNumber == 0)
          {
                PlayerSR.color = ColorAmarillo;
                currentColor ="Amarillo";
          }
          else if(randomNumber == 1)
          {
          PlayerSR.color = ColorMorado;
          currentColor ="Morado";
          }
